...
principal_data = pd.read_excel('https://raw.githubusercontent.com/Jtrejos2901/maps/main/casDataPais.xlsx', sheet_name=0)
location_data = pd.read_excel('https://raw.githubusercontent.com/Jtrejos2901/maps/main/casDataPais.xlsx', sheet_name=1)
...
app.run_server(debug=True)
    # Guarda el contenido HTML de tu aplicación en un archivo
with open('app.html', 'w') as f:
    f.write(app.index_string.format(app=app, layout=app.layout))